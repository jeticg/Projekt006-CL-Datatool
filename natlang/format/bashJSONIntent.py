...
# Python version: 3
#
# Bash Dataset Code Loader class
# For Bash intent stored in the same JSON format as provided by Yin et Neubig, 2017
...
if __name__ == '__main__':
    loaded = load(
        '/Users/ruoyi/Projects/PycharmProjects/data_fixer/bash_exported/train.jsonl')
